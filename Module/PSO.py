...
def opt_func_generate_points(params, polygon, distance):
...
def pyswarm_global_optimization(polygon, distance, maxiter, swarmsize):
    ...
    lb = [0,0,0]
    ub = [60,100,100]
    result = pso(opt_func_generate_points, lb, ub, swarmsize= swarmsize, maxiter= maxiter, args=(polygon, distance))
