...
def opt_pattern_calc(polygon, distance, opt_calc_iter,
                     opt_calc_iter_angle):
    # Platzhalter fuer die optimalen Koordinaten der Punkte
    opt_points = []
    ...
    for steps1 in range(opt_calc_iter_angle):
        ...
        for steps2 in range(opt_calc_iter):
            ...
            for steps3 in range(opt_calc_iter):
                ...
                # Muster mit der hoechsten Anzahl an Saatpunkten wird gespeichert
